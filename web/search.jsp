	...
	<%@ page import="com.jrmapp.lucene.search.*" %>
	...
	<div class="search">
	  ...
	  <TABLE>
	    <TBODY>
	      <TR>
	        <TD colspan="3">
	          <INPUT name=searchWord id=searchWord type=text size="40" value="<%=searchWord==null?"":searchWord %>"> 
 ...
 <TABLE class="result">
	  ...
	  <%
	    ...
	    for(int i = 0; i < resultCount; i++){
	    	...
	    	System.out.println(resultBean.getHtmlPath().indexOf("dataDir"));
	    	String path  = resultBean.getHtmlPath().substring(resultBean.getHtmlPath().indexOf("dataDir")+8);
	  %>
	  <TR>
	    <TD class="title"><h3><A href="<%=path %>"><%=title %></A></h3>
	    </TD>
	  </TR>
	  <tr><td><hr /></td></tr>
	  <%
